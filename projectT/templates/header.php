    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <a href="/index" class="flex items-center space-x-2 group">
                ...
                <span class="text-lg font-semibold text-gray-900">ระบบกิจกรรม</span>
            </a>

            <!-- Desktop Menu -->
            <div class="hidden md:flex items-center space-x-1">
                <a href="/index" class="nav-link px-4 py-2 rounded-lg text-sm font-medium text-gray-600 hover:text-blue-600 hover:bg-blue-50">
                    หน้าแรก
                </a>
        ...
        <div id="mobile-menu" class="hidden md:hidden pb-4 space-y-1">
            <a href="/index" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-lg">หน้าแรก</a>
            <?php if ($isLoggedIn): ?>
                <?php if ($isMember): ?>
